  ...
  return (
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left ">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="text-sm">
          Course by <span className="text-blue-600 underline">Jeet verma</span>
        </p>
      ...
      left clock icon"
          ...
          <div class="pt-6">
            <p class="md:text-xl text-lg font-medium text-gray-800">
              What's in the course?
            </p>
            <ul class="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
